      ...
      <div className="container mx-auto py-4">
        ...
        <div class="p-4 mt-4 text-sm flex flex-row text-gray-700 bg-gray-100 rounded-lg " role="alert">
          <div className='basis-5/6'>
            <span class="font-bold text-lg">BIST Office -  </span> BIST
          </div>
        ...
        <div class="p-4 mt-4 text-sm flex flex-row text-gray-700 bg-gray-100 rounded-lg " role="alert">
          <div className='basis-5/6'>
            <span class="font-bold text-lg">Manager room - </span>  MetLife
          </div>
        ...
        <div class="p-4 mt-4 text-sm flex flex-row text-gray-700 bg-gray-100 rounded-lg " role="alert">
          <div className='basis-5/6'>
            <span class="font-bold text-lg">Lab - </span> BIST
          </div>
